...
namespace SkillAssesmentCore
{
    ...
    public partial class Teachers
    {
        ...
        [Required(ErrorMessage = "Не выбрано учебное учреждение")]
        public Nullable<int> institution_id { get; set; }
        [Required(ErrorMessage = "Не выбран должность")]
        public Nullable<int> post_id { get; set; }
        [Required(ErrorMessage = "Не выбран предмет")]
        public Nullable<int> subject_id { get; set; }
        [Required(ErrorMessage = "Не выбрана квалификация")]
